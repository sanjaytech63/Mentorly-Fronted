...
import { FiShare2, FiLink, FiTwitter, FiFacebook, FiLinkedin, FiMessageCircle, FiMail, FiX } from 'react-icons/fi';
                    ...
                    <div className="absolute right-0 top-12 z-50 w-64 bg-white rounded-2xl shadow-xl border border-gray-200 p-4 animate-in fade-in-0 zoom-in-95">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {shareOptions.map((option) => (
                                ...
                                >
                                    <option.icon className={`w-5 h-5 mb-2 transition-transform group-hover:scale-110 ${option.color}`} />
