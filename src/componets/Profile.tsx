...
import { Card, Button, InputField, Loader } from "./index";
import { useAuth } from "../hooks/useAuth";
import { BiMailSend } from "react-icons/bi";
import { updateAvatar, updatePfofile } from "../api/authService";
...
const Profile = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await updatePfofile(fullName, email);
