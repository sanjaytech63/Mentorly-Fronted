    ...
    <Card padding="md" className="rounded-2xl  border border-gray-200 shadow-none">
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          ...
          <span
            className={`text-xs font-semibold px-2 py-1 rounded-full ${getCategoryColor(blog.category)}`}
          >
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm font-medium text-gray-900">{formatDate(blog.createdAt)}</span>
        </div>
        {blog.badge && (
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600">Status</span>
            <span
              className={`text-xs font-semibold px-2 py-1 capitalize rounded-full ${getBadgeColor(blog.badge)}`}
            >
              {blog.badge}
            </span>
          </div>
