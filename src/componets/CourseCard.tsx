...
import { Card, Rating, Price } from '../index';
...
const CourseCard: React.FC<CourseCardProps> = ({ course, onEnroll }) => {
  ...
  return (
    <Card
      padding="sm"
      className="flex flex-col h-full min-h-[350px] transition-transform duration-300 hover:scale-105"
    >
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <Price originalPrice={course.originalPrice} discountedPrice={course.discountedPrice} />
      </div>
