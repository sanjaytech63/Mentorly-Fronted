...
import { getBadgeColor, getBadgeLabel, getCategoryColor, getCategoryLabel, getLevelColor, getLevelLabel } from "../utils";
      ...
      >
        ...
        <div className="lg:w-64 flex-shrink-0 relative">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            {course.badge && (
              <span className={`inline-block px-3 py-1 text-xs font-semibold rounded-full border ${getBadgeColor(course.badge)}`}>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-3">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <span className={`px-2 py-1 text-xs font-medium rounded-full border ${getCategoryColor(course.category)}`}>
