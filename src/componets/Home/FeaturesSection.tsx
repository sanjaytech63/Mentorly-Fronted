...
const features = [
  {
    ...
    title: 'Expert Tutors',
    description: 'When an unknown printer took a galley of type and scrambled makes.',
    ...
    <section className="py-10 md:py-20 bg-white text-center">
      <Container>
        <div className="flex justify-center items-center">
          <p className="text-xs w-fit bg-[#F1EEFF] text-indigo-600 font-semibold px-4 py-2 rounded-full">
            Our Top Features
          </p>
        </div>
        <h2 className="text-2xl md:text-4xl font-bold text-[#161439] mt-3">
          Achieve Your Goal With <span className="text-indigo-600 ">SkillGrow</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          {features.map((feature, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-[#161439] mb-2">{feature.title}</h3>
