                ...
                <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
                    <div className="flex-1 space-y-6 z-10 text-center lg:text-left w-full">
                        ...
                        <p className="text-[#6D6C80] text-sm sm:text-base max-w-lg mx-auto lg:mx-0">
                            Edhen, an unknown printer took a galley of type and scrambled it to make a
                            type specimen book. It has survived not only five centuries but also the
                            leap into electronic typesetting Groove’s intuitive shared inbox makes it easy for team members to Now In One Place organize, prioritize and share classes seamlessly. .
                        </p>
