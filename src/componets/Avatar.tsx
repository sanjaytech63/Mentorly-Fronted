        ...
        <div ref={cardRef} className="relative inline-block">
            ...
            >
                ...
                <img
                    ...
                    style={{ width: size, height: size }}
                    className="rounded-full object-fit border border-gray-200 cursor-pointer transition-transform duration-300"
                />
            </div>
                ...
                <div className="absolute right-0 mt-3 w-60 p-4 bg-white rounded-xl shadow-lg border border-gray-100 z-[1000]">
                    ...
                    <div className="mt-4 flex flex-col gap-2">
                        <button
                            ...
                            className="text-sm text-indigo-600 hover:text-indigo-800 text-left cursor-pointer"
                        >
                            View Profile
                        </button>
                        <Button
