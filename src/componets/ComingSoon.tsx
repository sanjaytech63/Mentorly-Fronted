      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="my-16 ">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6">
            <span className="text-white/90">Mentorly</span>
          ...
          <p className="text-xl md:text-2xl text-white/70 max-w-3xl mx-auto mb-12 leading-relaxed">
            We're building something amazing to revolutionize your learning experience. Get ready to
            transform your career with cutting-edge technology and expert guidance.
          </p>
        </div>
        ...
        {/* Features Grid */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-12">What's Coming</h2>
