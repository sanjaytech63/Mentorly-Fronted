...
export const newsData: NewsItem[] = [
  {
    ...
    description:
      'Get Started With UI Design With Tips To Speed Up Your Design Process And Improve User Experience Significantly.',
    image:
  ...
  },
  {
    ...
    description:
      'What we are capable to usually discovered through continuous learning and practical application in real world scenarios.',
    image:
  ...
  {
    id: '3',
    title: 'When Known Printer Took A Galley Of Type Scanned Earpiece',
    description:
      "Discover the latest trends in modern printing technology and how it's revolutionizing the industry completely.",
    image:
  ...
  {
    id: '4',
    title: 'The Future of Digital Design in 2024',
    description:
      'Exploring new design trends and how they impact user interaction and experience across platforms.',
    image:
