...
export const callToAction: CallToAction = {
  ...
  content:
    'Develop market-relevant skills, accelerate your career growth, and join us in building a skilled, empowered youth community in India.',
...
export const features: Feature[] = [
  {
    ...
    description:
      'Our curriculum is designed in collaboration with industry experts to ensure you learn the most current and demanded skills. Each course combines theoretical knowledge with practical projects that simulate real-world challenges.',
    icon: 'course',
  },
  {
    title: 'Expert Mentors & Trainers',
    description:
      'Learn from seasoned professionals and industry veterans who bring years of practical experience. Our mentors provide personalized guidance, career advice, and industry connections to help you succeed.',
    icon: 'trainer',
  },
];
