  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative py-40 bg-gradient-to-r from-indigo-600 to-purple-700">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Learning Resources</h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-8 leading-relaxed">
              Discover expertly curated resources, guides, and learning paths to accelerate your
      ...
      <div className="relative -mt-16">
        ...
        <div className="">
          <Card
            className="group relative overflow-hidden border-0 py-10 bg-gradient-to-r from-indigo-600 to-purple-700 rounded-none  transition-all duration-500"
            padding="lg"
          >
            ...
            <div className="relative text-center">
              ...
              <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                Join thousands of learners who have accelerated their careers with Mentorly's
                expert-guided resources and community support.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
